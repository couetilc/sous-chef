...
path = Path("./scraping/recipe_scraping/recipe_csv_files/recipes_clean.csv")
...
with psycopg.connect(conn_info, row_factory = psycopg.rows.dict_row) as conn:
    with conn.cursor() as cur:
        ...
        cur.execute("CREATE TABLE recipes (id serial PRIMARY KEY, title TEXT, url TEXT, image TEXT, ingredients TEXT, steps TEXT)")
