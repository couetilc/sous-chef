    ...
    def handle(self, *args, **options):
        ...
        try:
            with open(csv_path, 'r', encoding='utf-8') as csvfile:
                ...
                if 'food_category' not in reader.fieldnames:
                    raise CommandError('CSV must have a "food_category" column')
                ...
                for row in reader:
                    ...
                    if food_category:
                        ingredient_food_category.add(food_category)
